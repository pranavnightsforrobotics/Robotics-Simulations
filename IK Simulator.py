...
def calculateIntakeWristAngle(curwristAngle):
    ...
    if(intakeEndToShoulderXOffset >  365):
        desiredWristToIntake = 660 - wristJoint[0]
...
while run:
    ...
    # Space Limit
    pygame.draw.rect(window, (0,0,0), ((140, 120), (520, 480)), 3)

    # Amp
    #pygame.draw.rect(window, (0,200,200), ((196, 600-ampTop), (ampDist, ampTop-ampBottom)), 3)
    #pygame.draw.rect(window, (0,200,200), ((570, 600-ampTop), (ampDist, ampTop-ampBottom)), 3)

    # Source
    #pygame.draw.line(window, (0, 200, 200), (570, 600-sourceHighHeight), (570, 600-sourceLowHeight), 3)
    #pygame.draw.line(window, (0, 200, 200), (570, 600-sourceHighHeight), (690, 600-sourceHighHeight-156), 3)
    #pygame.draw.line(window, (0, 200, 200), (570, 600-sourceLowHeight), (690, 600-sourceLowHeight-156), 3)
    #pygame.draw.line(window, (0, 200, 200), (690, 600-sourceHighHeight-156), (690, 600-sourceLowHeight-156), 3)

    # Ring
    #pygame.draw.rect(window, (255,127,0), ((600, 600-ringHeight), (ringLength, ringHeight)), 3)  
 
    # Bumpers
    pygame.draw.rect(window, (181,148,15), ((230, 542.5), (340, 57.5)), 3)

    # base to shoulder
    pygame.draw.line(window, (160, 32, 240), shoulderJoint, (295, 580), 3)
